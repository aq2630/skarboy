          ...
          <List>
            <Quest>
              <Accordion title="When will Metaversity launch its collection?">
                The official launch date of Metaversity is yet to be announced.
                We want to make sure we give the community as much as we can
                before we release our beautiful 3D Metaversity Monkeys.
              </Accordion>
            </Quest>
            <Quest>
              <Accordion title="Why should I join the Metaversity?">
                Our goal is to create a loving community of side hustlers who
                want to break the 9-to-5 job cycle and make money online.
              </Accordion>
            </Quest>
          </List>
          <List>
            <Quest>
              <Accordion title="Why should I buy a Metaversity Monkey? ">
                ...
                finely designed 3D artwork. These monkeys will be portrayed as
                the most prestigious in their class in the Metaverse.
              </Accordion>
            </Quest>
            <Quest>
          ...
          <List>
            <Quest>
              <Accordion title="Where can I get the latest information about Metaversity?">
                You can learn everything about the Metaversity in our discord.
                We currently have several thousands of members and host a
                multitude of events including NFT Masterclasses, interactive
                games, and student help sessions. In addition we offer many
                opportunities to get Whitelisted. Join our discord using this
                link: https://discord.gg/agb7A4hdDY
              </Accordion>
            </Quest>
            <Quest>
          ...
          <List>
            <Quest>
              <Accordion title="How many Metaversity Monkeys will conquer the New world?">
                ...
                art you purchase is of high quality by prioritizing excellence.
                As a result, demand for Metaversity Monkeys is quickly outpacing
                production.
              </Accordion>
            </Quest>
          </List>
